...
/**
 * A taglet that implements the "verifies.that" tag in JavaDoc. It shows a bullet point list of
 * preconditions that a method checks.
 */
...
public class VerifiesThatTaglet implements Taglet {
  ...
  private static final DocTreeVisitor<String, Void> visitor =
      new DocTreeScanner<>() {
        @Override
