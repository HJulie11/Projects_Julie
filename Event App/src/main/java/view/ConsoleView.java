...
public class ConsoleView implements IView {
  ...
  public static final int CONSUMER_MENU_REVIEW_EVENT = 6;
  public static final int CONSUMER_MENU_GET_EVENT_DIRECTIONS = 7;
  public static final int CONSUMER_MENU_LIST_EVENTS_MAX_DISTANCE = 8;
  ...
  public static final int STAFF_MENU_SAVE_APP_STATE = 7;
  public static final int STAFF_MENU_LOAD_APP_STATE = 8;
  ...
  public void displayStaffMenu() {
    ...
    System.out.println("[" + STAFF_MENU_SAVE_APP_STATE + "] SaveAppStateCommand");
    System.out.println("[" + STAFF_MENU_LOAD_APP_STATE + "] LoadAppStateCommand");
    System.out.println("[" + STAFF_MENU_RETURN + "] Return to main menu");
  }

  private static String formatMessage(
      String callerName, Object result, Map<String, Object> additionalInfo) {
   ...
   *
   * @param callerName human-readable name (usually in the format ClassName.MethodName) where the
   *     message is logged from
   ...
   *     message is logged from
   * @param result a single string representing the result of the operation that is being logged
   * @param additionalInfo a map containing any additional information that may help to explain the
   *     result, the keys should be variable names and the values should be their values. For
   *     convenience, the values are allowed to be any {@link Object}s that get converted to {@link
   *     String}s
   */
  @Override
  ...
  public void displayFailure(String callerName, Object result, Map<String, Object> additionalInfo) {
    System.out.println(
        ANSI_YELLOW + formatMessage(callerName, result, additionalInfo) + ANSI_RESET);
  }
}
