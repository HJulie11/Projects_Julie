...
/**
 * {@link UpdateStaffProfileCommand} allows {@link Staff} members to update their account details in
 * the system.
 */
public class UpdateStaffProfileCommand extends UpdateProfileCommand {
   ...
   */
  public UpdateStaffProfileCommand(String oldPassword, String newEmail, String newPassword) {
  ...
  public void execute(Context context, IView view) {
    ...
    if (oldPassword == null || newEmail == null || newPassword == null) {
      view.displayFailure(
          ...
          Map.of(
              "oldPassword", "***", "newOrgEmail", String.valueOf(newEmail), "newPassword", "***"));
      successResult = null;
      return;
    }
    ...
    if (!(currentUser instanceof Staff)) {
      view.displayFailure("UpdateStaffProfileCommand", LogStatus.USER_UPDATE_PROFILE_NOT_STAFF);
      successResult = false;
      return;
    }
    ...
    view.displaySuccess(
        ...
        Map.of("newEmail", newEmail, "newPassword", "***"));
    successResult = true;
  }
