...
/**
 * {@link RegisterStaffCommand} allows users to register a new {@link Staff} account on the system.
...
public class RegisterStaffCommand implements ICommand<Staff> {
   ...
   */
  public RegisterStaffCommand(String email, String password, String secret) {
    this.email = email;
