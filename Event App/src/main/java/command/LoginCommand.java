...
/**
 * {@link LoginCommand} allows a previously registered {@link User} to log in to the system by
 * providing their login details.
 */
public class LoginCommand implements ICommand<User> {
  ...
  public void execute(Context context, IView view) {
    ...
    view.displaySuccess(
        "LoginCommand", LogStatus.USER_LOGIN_SUCCESS, Map.of("email", email, "password", "***"));
    userResult = user;
  }
