...
/**
 * {@link ListEventBookingsCommand} allows an event organiser ({@link Staff}) to get a list of all
 * {@link Booking}s for a chosen {@link Event}.
 */
public class ListEventBookingsCommand implements ICommand<List<Booking>> {
   ...
   * @verifies.that currently logged-in user is either a government representative or the organiser
   *     of the event
   */
  @Override
