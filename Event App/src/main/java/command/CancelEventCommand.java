...
/**
 * {@link CancelEventCommand} allows {@link Staff} members to cancel a previously added {@link
 * Event}. This cancels and refunds all bookings linked to the event.
 */
public class CancelEventCommand implements ICommand<Boolean> {
   ...
   * @param organiserMessage message from the organiser to the {@link Consumer}s who had {@link
   *     Booking}s for the event
   */
  ...
  public void execute(Context context, IView view) {
    ...
    view.displaySuccess(
        "CancelEventCommand", LogStatus.CANCEL_EVENT_SUCCESS, Map.of("eventNumber", eventNumber));
    successResult = true;
  }
