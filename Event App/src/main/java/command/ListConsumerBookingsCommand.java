...
/**
 * {@link ListConsumerBookingsCommand} allows a logged-in {@link Consumer} to get a list of all
 * their own {@link Booking}s.
 */
public class ListConsumerBookingsCommand implements ICommand<List<Booking>> {
  ...
  public void execute(Context context, IView view) {
    ...
    // List bookings
    view.displaySuccess("ListConsumerBookingsCommand", LogStatus.LIST_CONSUMER_BOOKINGS_SUCCESS);
