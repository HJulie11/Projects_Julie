...
public class UserLoginTests extends ConsoleTest {
  ...
  void createConsumer() {
    ...
    controller.runCommand(
        new RegisterConsumerCommand("Ronald McDonald", "always@lovin.it", "000", "", "McMuffin"));
  ...
  void createStaff() {
    ...
    startOutputCapture();
    controller.runCommand(
        new RegisterStaffCommand("always@lovin.it", "Ronald McDonald", "Nec temere nec timide"));
    stopOutputCaptureAndCompare("REGISTER_STAFF_SUCCESS", "USER_LOGIN_SUCCESS");
  }
  ...
  void createStaffAndRelogin() {
    ...
    startOutputCapture();
    controller.runCommand(
        new RegisterStaffCommand("always@lovin.it", "McMuffin", "Nec temere nec timide"));
    controller.runCommand(new LogoutCommand());
    controller.runCommand(new LoginCommand("always@lovin.it", "McMuffin"));
    stopOutputCaptureAndCompare(
